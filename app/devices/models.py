...
class Device(models.Model):
    ...
    auth_token = models.CharField(
        ...
        help_text="Device authentication token for registration",
    )
    token_generated_at = models.DateTimeField(
        null=True, blank=True,
        help_text="Timestamp when auth_token was generated",
    )
    ...
    def generate_token(self):
        """Generate a new auth token for device registration."""
