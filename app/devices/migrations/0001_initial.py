# Generated by Django 5.2.10 on 2026-04-08 09:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('online', 'Online'), ('offline', 'Offline'), ('error', 'Error')], default='active', max_length=20)),
                ('auth_token', models.CharField(blank=True, help_text='Device authentication token for registration', max_length=64, null=True, unique=True)),
                ('token_generated_at', models.DateTimeField(blank=True, help_text='Timestamp when auth_token was generated', null=True)),
